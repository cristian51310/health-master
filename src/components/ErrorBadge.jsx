export function ErrorBadge ({ errorMessage }) {
  return (
    <span class='inline-flex items-center m-2 px-3 py-1 bg-red-200 rounded-full text-sm font-semibold text-red-600'>
