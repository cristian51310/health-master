    ...
    <DefaultLayout>
      ...
      <div className='rounded-sm border border-stroke bg-white p-4 shadow-default     md:p-6 xl:p-9'>
        <div className='flex flex-col gap-7.5'>
          ...
          {/* <!-- Alerts Item --> */}
          <div className='flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-5 shadow-md md:p-6'>
          ...
          {/* <!-- Alerts Item --> */}
          <div className='flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-5 shadow-md md:p-6'>
